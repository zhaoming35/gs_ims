...
{
    public partial class CmbPayWay : Miles.Framework.UI.Controls.MComboBox
    {
        public CmbPayWay()
        {
            InitializeComponent();
        ...
        {
            List<Tb_enum> dt = Enum.EnumText.GetEnumManager().FindKindAllInfo("Pay_Way");

            List<Miles.Framework.UI.Controls.ColumnMap> columnsMap = new List<Miles.Framework.UI.Controls.ColumnMap>();
            columnsMap.Add(new Miles.Framework.UI.Controls.ColumnMap(Tb_enum.Table.Enum_Text, "付款方式", true));
