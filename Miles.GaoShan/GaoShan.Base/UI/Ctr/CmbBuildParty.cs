...
{
    public partial class CmbBuildParty : Miles.Framework.UI.Controls.MComboBox
    {
        public CmbBuildParty()
        {
            InitializeComponent();
        }
        ...
        {
            List<Tb_enum> dt = Enum.EnumText.GetEnumManager().FindKindAllInfo("BuildParties");
