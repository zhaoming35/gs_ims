...
{
	[TableAttribute("tb_store_check_log","gaoshan_db")]
	[Serializable]
	public class Tb_store_check_log
	{
		...
		private decimal _check_Qty;
		/// <summary>
		///
		/// </summary>
		[Description("check_Qty")]
		[DataFieldAttribute("check_Qty", "decimal", "")]
		...
		{
			return "["+"Mtl_Code="+this._mtl_Code+ ","+"Store_Room="+this._store_Room+ ","+"Check_Qty="+this._check_Qty+ ","+"Mtl_Qty="+this._mtl_Qty+"]";
		}
	...
	public class Table
	{
		...
		///
		/// </summary>
		public const string Check_Qty="Check_Qty";
		/// <summary>
		///
		/// </summary>
