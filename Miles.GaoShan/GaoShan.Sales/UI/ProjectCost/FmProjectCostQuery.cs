...
{
    public partial class FmProjectCostQuery : Miles.Framework.UI.Forms.FmMdi
    {
        ...
        protected override void Query(ToolStripButton sender)
        {
            ...
            List<Model.Q_project_Cost_Item> list = manager.QueryCostItemRecord(beginDate.Value, endDate.Value, txtOrderNo.Text);
