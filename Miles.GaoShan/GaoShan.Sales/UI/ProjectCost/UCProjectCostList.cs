...
{
    public partial class UCProjectCostList : UCBase
    {
        public UCProjectCostList()
        {
            InitializeComponent();
        ...
        public void UpdateCurrentValue(Model.Info_project_Cost info)
        {
            this.mDataGridNvl.EditCurrentItem<Model.Info_project_Cost>(info);
        }
        ...
        void mDataGridNvl_CurrentRowChanged(object sender, EventArgs e)
        {
            ...
            Model.Info_project_Cost info = mDataGridNvl.GetCurrentEntity() as Model.Info_project_Cost;
        ...
        public override void SetDataSource(object dataSource)
        {
            ...
            List<Model.Info_project_Cost> list = dataSource as List<Model.Info_project_Cost>;

            if (list != null)
                this.mDataGridNvl.SetDataSource<Model.Info_project_Cost>(list);
        }
        ...
        void ComboBox_SelectedValueChanged(object sender, EventArgs e)
        {
            ...
            {
                mDataGridNvl.SetFilter<Model.Info_project_Cost>(delegate (Model.Info_project_Cost p) { return p.Odr_Type == orderType|| orderType==-1; });
            }
            else
            {
                mDataGridNvl.SetFilter<Model.Info_project_Cost>(delegate (Model.Info_project_Cost p)
                {
