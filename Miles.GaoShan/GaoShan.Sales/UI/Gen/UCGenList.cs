...
{
    public partial class UCGenList : UCBase
    {
        public UCGenList()
        {
            InitializeComponent();
        ...
        public override void SetDataSource(object dataSource)
        {
            ...
            List<Model.Info_fin_order_gen> list = dataSource as List<Model.Info_fin_order_gen>;

            if (list != null)
                this.mDataGridNvl.SetDataSource<Model.Info_fin_order_gen>(list);
        }
        ...
        void ComboBox_SelectedValueChanged(object sender, EventArgs e)
        {
            ...
            {
                mDataGridNvl.SetFilter<Model.Info_fin_order_gen>(delegate (Model.Info_fin_order_gen p) { return p.Odr_Type == orderType|| orderType==-1; });
            }
            else
            {
                mDataGridNvl.SetFilter<Model.Info_fin_order_gen>(delegate (Model.Info_fin_order_gen p)
                {
