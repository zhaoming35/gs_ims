...
{
    public partial class UCIncomeList : UCBase
    {
        public UCIncomeList()
        {
            InitializeComponent();
        ...
        public void UpdateCurrentValue(Model.Info_fin_order_income info)
        {
            this.mDataGridNvl.EditCurrentItem<Model.Info_fin_order_income>(info);
        }
        ...
        void mDataGridNvl_CurrentRowChanged(object sender, EventArgs e)
        {
            ...
            Model.Info_fin_order_income info = mDataGridNvl.GetCurrentEntity() as Model.Info_fin_order_income;
        ...
        public override void SetDataSource(object dataSource)
        {
            ...
            List<Model.Info_fin_order_income> list = dataSource as List<Model.Info_fin_order_income>;

            if (list != null)
                this.mDataGridNvl.SetDataSource<Model.Info_fin_order_income>(list);
        }
        ...
        void ComboBox_SelectedValueChanged(object sender, EventArgs e)
        {
            ...
            {
                mDataGridNvl.SetFilter<Model.Info_fin_order_income>(delegate (Model.Info_fin_order_income p) { return p.Odr_Type == orderType|| orderType==-1; });
            }
            else
            {
                mDataGridNvl.SetFilter<Model.Info_fin_order_income>(delegate (Model.Info_fin_order_income p)
                {
