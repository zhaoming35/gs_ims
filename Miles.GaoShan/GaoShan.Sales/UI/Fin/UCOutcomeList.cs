...
{
    public partial class UCOutcomeList : UCBase
    {
        public UCOutcomeList()
        {
            InitializeComponent();
        ...
        public override void SetDataSource(object dataSource)
        {
            ...
            List<Model.Info_fin_order_outcome> list = dataSource as List<Model.Info_fin_order_outcome>;

            if (list != null)
                this.mDataGridNvl.SetDataSource<Model.Info_fin_order_outcome>(list);
        }
        ...
        void ComboBox_SelectedValueChanged(object sender, EventArgs e)
        {
            ...
            {
                mDataGridNvl.SetFilter<Model.Info_fin_order_outcome>(delegate (Model.Info_fin_order_outcome p) { return p.Odr_Type == orderType|| orderType==-1; });
            }
            else
            {
                mDataGridNvl.SetFilter<Model.Info_fin_order_outcome>(delegate (Model.Info_fin_order_outcome p)
                {
