...
{
    public partial class UCOrderBodyLease : UCBase
    {
        bool blUpdate = false;
        ...
        {
            string strValue = Miles.Coro.Common.MoneyConvert.ToWord(d_totCost.Value);
            lblRmb.Text = strValue;
        }
        ...
        public override void SetTabControls(Miles.Framework.UI.Forms.TabControlSeq tabControlSeq)
        {
            ...
            this.tabControlSeq.AddContainer(this.groupBox15);
