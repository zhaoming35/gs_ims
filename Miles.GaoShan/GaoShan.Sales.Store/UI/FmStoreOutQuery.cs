...
{
    public partial class FmStoreOutQuery : Miles.Framework.UI.Forms.FmMdi
    {
        ...
        protected override void Query(ToolStripButton sender)
        {
            ...
            List<Model.Q_store_out_item> list = manager.QueryStoreOutRecord(beginDate.Value, endDate.Value, txtOrderNo.Text);
            mDataGrid1.SetDataSource<Model.Q_store_out_item>(list);
        }
