...
{
    public partial class UCBackOrderList : GaoShan.Sales.UI.UC.UCBase
    {
        public UCBackOrderList()
        {
            InitializeComponent();
        }
        ...
        void txtSearch_TextChanged(object sender, EventArgs e)
        {
            ...
            {
                mDataGridNvl.SetFilter<Model.Info_store_in>(null);
            }
            else
            {
                mDataGridNvl.SetFilter<Model.Info_store_in>(delegate (Model.Info_store_in p)
                {
        ...
        public override void SetDataSource(object dataSource)
        {
            ...
            List<Model.Info_store_in> list = dataSource as List<Model.Info_store_in>;

            if (list != null)
                this.mDataGridNvl.SetDataSource<Model.Info_store_in>(list);
        }
